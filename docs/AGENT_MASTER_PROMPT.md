...
- На **mobile** (&lt;768px) нижняя панель **`AprilMobileShellBar`** — **один активный контекст**: при открытой модалке/нижнем листе сценария в панели **только** его кнопки, без глобальных табов экрана; см. `DESIGN_SYSTEM.md` §8 Mobile и §11.

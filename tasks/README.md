...
- `ds-012-mobile-bottom-panel` - done — `AprilMobileShellBar`, inset `aprilMobileShellBarContentPaddingBottom()`, вкладка **Mobile lab** в showcase (`MobileShowcase.tsx`, кадры 390×844 / 360×800); см. `TASK.md`, `REPORT.md`.
